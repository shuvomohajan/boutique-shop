      ...
      <div class="row no-gutters">
        <div class="col-xl-3 col-lg-4 col-md-5">
          ...
          <div class="fb-banner fb-img-hover-effect">
            <a href="#">
              <img src="{{asset('storage/'.$feature->image) }}" alt="FB'S Banner">
            </a>
          </div>
        ...
        <div class="col-xl-9 col-lg-8 col-md-7">
          ...
          <div class="fb-list_product">
            <div class="fb-list_product_active owl-carousel">
              @foreach ($feature->FeatureProducts->chunk(2) as $productCollection)
      ...
      <div class="col-lg-12">
        ...
        <div class="fb-single-product-slide_wrap bg-white mb-30">
          <div class="fb-product_active-3 owl-carousel">
            <!-- Begin Sigle Product Area -->
            @foreach ($feature->FeatureProducts as $product)
            @php
            $product = $product->Products;
            @endphp
