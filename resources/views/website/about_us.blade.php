                ...
                <div class="row">
                    {{--<div class="col-lg-6">
                        <div class="about-thumb fb-img-hover-effect">
                            <a href="#">
                                <img src="{{asset('/')}}website/Images/about-us/1.jpg" alt="about image">
                            </a>
                        </div>
                    </div>--}}
                    <div class="col-lg-12">
            ...
            <div class="container">
                ...
                <div class="row team-wrapper">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="single-team">
                            <div class="single-team-thumb">
                                <img src="{{asset('/')}}website/Images/about-us/team/1.jpg" alt="team image">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="single-team">
                            <div class="single-team-thumb">
                                <img src="{{asset('/')}}website/Images/about-us/team/2.jpg" alt="team image">
                            </div>
                            <div class="single-team-content">
                                <h4>Maria Mandy</h4>
                                <h6>Web Developer</h6>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                        <div class="single-team">
                            <div class="single-team-thumb">
                                <img src="{{asset('/')}}website/Images/about-us/team/3.jpg" alt="team image">
                            </div>
                            <div class="single-team-content">
                                <h4>Niki Adams</h4>
