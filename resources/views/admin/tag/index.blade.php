            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{route('tag.create')}}" class="btn btn-default btn-icon-sm">
                ...
                <tbody>
                    ...
                    @foreach($tags as $tag)
                        <tr>
                            ...
                            <td>
                                <img src="{{ !is_null($tag->icon) ? asset('storage/'.$tag->icon) : asset('storage/images/default.png') }}" alt="avater" height="60px" width="60px"/>
                            </td>
                            <td>
                                {{$tag->name}}
                            </td>
                            ...
                            <td>
                                <form method="post" action="{{ route('tag.destroy',$tag->id) }}">
                                    <a href="{{ route('tag.edit',$tag->id) }}" class="btn-label-brand btn btn-sm btn-bold">Edit</a>
                                    @csrf
                                    @method('DELETE')
