  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="kt-portlet">
        ...
        <form class="kt-form kt-form--label-right" enctype="multipart/form-data" method="POST" action="{{route('categorysection.update',$cat_section->id)}}">
          @csrf
          @method('PUT')
          <div class="kt-portlet__body">
            <div class="form-group row">
              ...
              <div class="col-lg-8">
                ...
                <input name="name" id="name" value="{{$cat_section->name}}" placeholder="Ex: Smith Jones" type="text" class="form-control  @error('name') is-invalid @enderror">
                @error('name')
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-8">
                ...
                <select class="form-control select2" name="category_id">
                  <option >-- Select  Section category --</option>
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-8">
                ...
                <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_1">
                  <div id="image" class="kt-avatar__holder_cover" style="background-image: url('{{ asset('storage/'.$cat_section->image) }}')"> </div>
