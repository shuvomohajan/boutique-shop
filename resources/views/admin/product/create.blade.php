      ...
      <div class="kt-portlet__body">
        <div class="row">
          <div class="col-lg-7">
            <div class="form-group">
              <label for="name"><b>{{__('Product Name')}} <span class="text-danger">*</span></b></label>
            ...
            <div class="form-group">
              ...
              <input name="sku" id="sku" value="{{old('sku') ?? $sku}}" placeholder="Ex: #P202173674" type="text" class="form-control  @error('sku') is-invalid @enderror">
              @error('sku')
            ...
            <div class="form-group">
              ...
              <textarea class="form-control @error('short_description') is-invalid @enderror" name="short_description" placeholder="Enter a product Short Description..." minlength="40"
                maxlength="1000" rows="3">{{old('short_description')}}</textarea>
            ...
            <div class="form-group row">
              <div class="col-lg-12">
                <label for="category_id"><b>{{__('product Category')}} <span class="text-danger">*</span></b></label>
            ...
            <div class="form-group row">
              <div class="col-lg-12">
                ...
                <select class="form-control select2-withTag" name="subject_id" value="{{ old('subject_id') }}">
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-6">
                ...
                <select class="form-control select2-withTag" name="year" value="{{ old('year')}}">
                  @for($i = date("Y"); $i >= 1800; $i--) <option value="{{ $i }}" {{ old('year') == $i ? 'selected' : '' }}>{{ $i }}</option>@endfor
                </select>
                @error('year')
                <span class="text-danger"><strong>{{ $message }}</strong></span>
                @enderror
            ...
            <div class="form-group row">
              <div class="col-lg-6">
                <label for="format_id"><b>{{__('Product Format')}} <span class="text-danger">*</span></b></label>
                <select class="form-control select2-withTag" name="format_id" value="{{ old('format_id') }}">
                  @foreach ($formats as $format)
                  <option value="{{ $format->id }}" {{ old('format_id') == $format->id ? 'selected' : null }}>{{ $format->name }}</option>
                  @endforeach
                </select>
                @error('format_id')
                <span class="text-danger"><strong>{{ $message }}</strong></span>
              ...
              <div class="col-lg-6">
                <label for="language_id"><b>{{__('Product Language')}} <span class="text-danger">*</span></b></label>
                <select class="form-control select2-withTag" name="language_id" value="{{ old('language_id') }}">
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-6">
                ...
                <input name="page" id="page" value="{{old('page')}}" placeholder="Ex: 100 " type="number" class="form-control  @error('page') is-invalid @enderror">
                @error('page')
                <span class="text-danger"><strong>{{ $message }}</strong></span>
                @enderror
            ...
            <div class="form-group row">
              <div class="col-lg-4">
                <label for="regular_price"><b>{{__('Regular Price')}} <span class="text-danger">*</span></b></label>
            ...
            <div class="form-group">
              ...
              <select name="seo_key_word[]" id="seo_key_word" value="{{old('seo_key_word')}}" class="form-control select2-withTag @error('seo_key_word') is-invalid @enderror" multiple></select>
              @error('seo_key_word')
              <span class="text-danger"><strong>{{ $message }}</strong></span>
              @enderror
              <span class="form-text text-muted">Please enter the Product Regular Price.</span>
            ...
            <div class="form-group">
              <div>
                <label for="image"><b>{{__('Product Image')}} <span class="text-danger">*</span></b></label>
              </div>
              <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_1">
                ...
                <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="Change">
                  <i class="fa fa-pen"></i>
                  <input type="file" value="{{old('image')}}" class="@error('image') is-invalid @enderror" onchange="readURL(this, '#image')" name="image" accept=".png, .jpg, .jpeg">
                </label>
            ...
            <div class="form-group">
              <div>
                <label for="social_image"><b>{{__('Social Image')}}</b></label>
              </div>
              <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_1">
                <div id="social_image" class="kt-avatar__holder_cover" > </div>
                <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="Change">
                  <i class="fa fa-pen"></i>
                  <input type="file" value="{{old('social_image')}}" class="@error('social_image') is-invalid @enderror" onchange="readURL(this, '#social_image')" name="social_image" accept=".png, .jpg, .jpeg">
                </label>
          ...
          <div class="col-lg-5">
            <div class="form-group">
              <label for="author_id"><b>{{__('Author')}} <span class="text-danger">*</span></b></label>
              <select class="form-control select2" name="author_id" value="{{ old('author_id') }}">
                @foreach ($authors as $author)
                <option value="{{ $author->id }}" {{ old('author_id') == $author->id ? 'selected' : null }}>{{ $author->name }}</option>
                @endforeach
              </select>
              @error('author_id')
              <span class="text-danger"><strong>{{ $message }}</strong></span>
            ...
            <div class="form-group">
              <label for="publisher_id"><b>{{__('Publisher')}} <span class="text-danger">*</span></b></label>
              <select class="form-control select2" name="publisher_id" value="{{ old('publisher_id') }}">
                @foreach ($publishers as $publisher)
                <option value="{{ $publisher->id }}" {{ old('publisher_id') == $publisher->id ? 'selected' : null }}>{{ $publisher->name }}</option>
                @endforeach
              </select>
              @error('publisher_id')
              <span class="text-danger"><strong>{{ $message }}</strong></span>
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-6">
                <label class="checkbox">
                  <input name="features[]" value="{{ $feature->id }}" {{ old($feature->id) ? "checked" : null }} type="checkbox" class=" @error($feature->id) is-invalid @enderror">
        ...
        <div class="row">
          ...
          <div class="col-6 col-md-4 col-lg-2">
            <div class="form-group">
              <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_1">
                <div id="gallery2" class="kt-avatar__holder_icon" > </div>
                <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="Change">
                  <i class="fa fa-pen"></i>
          ...
          <div class="col-6 col-md-4 col-lg-2">
            <div class="form-group">
              <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_1">
                <div id="gallery3" class="kt-avatar__holder_icon" > </div>
                <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="Change">
                  <i class="fa fa-pen"></i>
          ...
          <div class="col-6 col-md-4 col-lg-2">
            <div class="form-group">
              <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_1">
                <div id="gallery4" class="kt-avatar__holder_icon" > </div>
                <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="Change">
                  <i class="fa fa-pen"></i>
          ...
          <div class="col-6 col-md-4 col-lg-2">
            <div class="form-group">
              <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_1">
                <div id="gallery5" class="kt-avatar__holder_icon" > </div>
                <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="Change">
                  <i class="fa fa-pen"></i>
