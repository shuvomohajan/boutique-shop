            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{route('subject.create')}}" class="btn btn-default btn-icon-sm">
                ...
                <tbody>
                    ...
                    @foreach($subjects as $subject)
                        <tr>
                            ...
                            <td>
                                <img src="{{ !is_null($subject->icon) ? asset('storage/'.$subject->icon) : asset('storage/images/default.png') }}" alt="avater" height="60px" width="60px"/>
                            </td>
                            <td>
                                {{$subject->name}}
                            </td>
                            ...
                            <td>
                                <form method="post" action="{{ route('subject.destroy',$subject->id) }}">
                                    <a href="{{ route('subject.edit',$subject->id) }}" class="btn-label-brand btn btn-sm btn-bold">Edit</a>
                                    @csrf
                                    @method('DELETE')
