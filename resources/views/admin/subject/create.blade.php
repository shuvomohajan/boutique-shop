  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="kt-portlet">
        ...
        <form class="kt-form kt-form--label-right" enctype="multipart/form-data" method="POST" action="{{route('subject.store')}}">
          @csrf
          <div class="kt-portlet__body">
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-8">
                ...
                <textarea class="form-control @error('details') is-invalid @enderror" name="details" placeholder="Enter User About..." minlength="100" maxlength="1000" rows="5">{{old('details')}}</textarea>
                @error('details')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-8">
                <div>
                  <label for="icon" class=""><b>{{__('Subject Icon')}}</b></label>
                </div>
                <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_1">
                  <div id="cvr_img" class="kt-avatar__holder" style="background-icon: url()"> </div>
                  <label class="kt-avatar__upload" data-toggle="kt-tooltip" title="" data-original-title="Change">
                    <i class="fa fa-pen"></i>
                    <input type="file" value="{{old('icon')}}" class="@error('icon') is-invalid @enderror" onchange="readURL(this)" name="icon" accept=".png, .jpg, .jpeg">
                  </label>
