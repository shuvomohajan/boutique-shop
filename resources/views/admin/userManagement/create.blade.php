        ...
        <div class="kt-portlet">
          ...
          <form class="kt-form kt-form--label-right" enctype="multipart/form-data" method="POST" action="{{route('user.store')}}">
            ...
            <div class="kt-portlet__body">
              ...
              <div class="form-group row" id="experience_box" style="display: none">
                <div class="col-lg-2"></div>
                <div class="col-lg-8">
                  <label for="experience" class=""><b>{{__('Experience')}}</b></label>
                  <input name="experience" id="experience" value="{{old('experience')}}" placeholder="4 years" type="text" class="form-control  @error('experience') is-invalid @enderror">
                  @error('experience')
                  <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
