  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="kt-portlet">
        ...
        <form class="kt-form kt-form--label-right" enctype="multipart/form-data" method="POST" action="{{route('subcategory.update', $subcategory->id)}}">
          @csrf
          @method('PUT')
          <div class="kt-portlet__body">
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-8">
                ...
                <select class="form-control select2-withTag" name="category_id" value="{{ old('category_id') ?? $subcategory->category_id }}">
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-8">
                ...
                <div class="kt-avatar kt-avatar--outline" id="kt_user_avatar_1">
                  <div id="icon" class="kt-avatar__holder_icon" style="background-image: url({{asset('storage/'.$subcategory->icon)}})"> </div>
